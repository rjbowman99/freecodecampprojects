...
--
-- Name: games team_id_fk_for_opponent_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT team_id_fk_for_opponent_id FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games team_id_fk_for_winner_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT team_id_fk_for_winner_id FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
